...
# Нижній рівень — z8, а не 9,5: старт показує увесь Київ (розд. 25, А3), і на
# екрані телефона (390 px) це приблизно z8,5 — нижче за колишній найдрібніший
# рівень кільця налазили одне на одне.
