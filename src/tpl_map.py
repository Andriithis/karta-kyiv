# -*- coding: utf-8 -*-
"""Карта й шари на Leaflet.

Тут: створення карти Leaflet, підкладка й шари — населення, потоки, ризики,
чинники середовища, теплова карта, маски й межі районів — і підсвітка
«що поруч».

Функції: showNear, showAllNear, drawFacts, riskPopup, drawRisks,
enterDistrict, exitDistrict, setTheme.
Дані й палітра — у tpl_base, панель і вікна — у tpl_core, позначки подій —
у tpl_draw. Той самий набір на MapLibre — у tpl_gl.
"""
JS_MAP = r"""const map=L.map('map',{preferCanvas:true}).setView(M.center||[50.45,30.52],M.only?13:11);
